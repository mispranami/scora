...
public class ExamPage extends JFrame {
    ...
    private void setupUI() {
        ...
        headerPanel.setBackground(new Color(76, 120, 111)); // Teal green color
        ...
        previousButton.setBackground(new Color(76, 120, 111));
        ...
        nextButton.setBackground(new Color(76, 120, 111));
        ...
        submitButton.setBackground(new Color(76, 120, 111));
   ...
   private void startExamTimer() {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            new ExamPage("S001", "E001").setVisible(true);
        });
    }
}
